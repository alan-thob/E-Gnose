...
<body class="unselectable">
    ...
    <section id="carousel-content">
        <div class="container">
            ...
            <div class="title">
                <h3>Titres les plus récents du site</h3>
            </div>
            <div id="carousel0">
                <?php
            ...
            <div class="title">
                <h3>Par Walt Disney ou Paramount</h3>
            </div>
            <div id="carousel2">
                <?php
                $allRessources = $db->prepare('SELECT * FROM films WHERE film_value = 1 AND film_realisateur = "Walt Disney Pictures" OR film_realisateur = "Paramount" ORDER BY film_popularity DESC LIMIT 10; ');
                $allRessources->execute();
                if ($allRessources->rowCount() > 0) {
                    while ($ressources = $allRessources->fetch()) {
                        echo '<div class="item" style="width: 85%">
            ...
            <div class="title">
                <h3>Par Warner Bros. Pictures</h3>
            </div>
            <div id="carousel3">
                <?php
                $allRessources = $db->prepare('SELECT * FROM films WHERE film_value = 1 AND film_realisateur = "Warner Bros. Pictures" ORDER BY film_popularity DESC LIMIT 10; ');
                $allRessources->execute();
                if ($allRessources->rowCount() > 0) {
                    while ($ressources = $allRessources->fetch()) {
                        echo '<div class="item" style="width: 85%">
            ...
            <div class="title">
                <h3>Titres les plus ancien du site</h3>
            </div>
            <div id="carousel4">
                <?php
                $allRessources = $db->prepare('SELECT * FROM films WHERE film_value = 1 ORDER BY film_popularity ASC LIMIT 10');
                $allRessources->execute();
                if ($allRessources->rowCount() > 0) {
                    while ($ressources = $allRessources->fetch()) {
                        echo '<div class="item" style="width: 85%">
